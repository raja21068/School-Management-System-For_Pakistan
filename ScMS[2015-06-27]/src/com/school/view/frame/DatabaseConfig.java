...
public class DatabaseConfig extends javax.swing.JFrame {
    ...
    public DatabaseConfig(int option) {
        ...
        if (option == SAVE_OPTION) {
            ...
            try {
                ...
                AppMsg.error(this, D_Msg.MSG_9+D_Msg.MSG_10+D_Msg.MSG_11);
                Logger.getLogger(AppLog.FATAL_LOG).log(Level.SEVERE, null, ex);
                System.exit(-1);
            }
        }
    ...
    private void initComponents() {
        ...
        buttonNext.setIcon(new javax.swing.ImageIcon(getClass().getResource(com.school.config.AppIcon.RIGHT_ARROW)));
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    AppMsg.error(DatabaseConfig.this, D_Msg.MSG_12 );
                    Logger.getLogger(AppLog.FATAL_LOG).log(Level.SEVERE, null, ex);
                    System.exit(-1);
                }
            }
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    AppMsg.error(DatabaseConfig.this, D_Msg.MSG_12 ,ex);
                    Logger.getLogger(AppLog.FATAL_LOG).log(Level.SEVERE, null, ex);
                    System.exit(-1);
                } catch (Exception ex) {
                    AppMsg.error(DatabaseConfig.this, D_Msg.MSG_13 ,ex);
                    Logger.getLogger(AppLog.FATAL_LOG).log(Level.SEVERE, null, ex);
                    System.exit(-1);
                }
                String userPanel = Forms.USERS.getValue();
                UserManagePanel panel = new UserManagePanel(new UserPrivilege(null, new Module(userPanel ), true, true, true, true), true);
