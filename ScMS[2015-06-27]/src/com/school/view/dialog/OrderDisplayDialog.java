package com.school.view.dialog;
...
public class OrderDisplayDialog extends javax.swing.JDialog {
    ...
    public OrderDisplayDialog(javax.swing.JPanel parent, String name, List list,String refreshingMethod) {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        new Thread() {
            ...
            public void run() {
                ...
                AppMsg.info(OrderDisplayDialog.this, D_Msg.MSG_7);
