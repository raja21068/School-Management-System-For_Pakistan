 ...
 * @author JAY
 */
public class FeesPanel extends JkPanel {

    SchoolConfig nameConfig = null;

    public FeesPanel(UserPrivilege privilege) {
        super(privilege);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FEES GENERATE & PAYMENT");
        ...
        buttonGenerateChallan.setText("Generate Fee");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(dateChooserDueDate, javax.swing.GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jTabbedPane1.addTab("Class Students", panelStudents);
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(checkBoxLateFee, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {buttonPrintUnpaidChallan, checkBoxAnotherMonth, comboBoxMonthUnpaidOther, comboBoxYearUnpaidOther, jLabel10, textFieldSearch});
    ...
    private void buttonGenerateChallanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGenerateChallanActionPerformed
        ...
        if (dueDate == null || issueDate == null) {
            AppMsg.warning(this, D_Msg.MSG_66);
            return;
        }
        ...
        if (!checkBoxApplyDiscount.isSelected()) {
            int option = AppMsg.confirm2(this, D_Msg.MSG_70);
        ...
        try {
            ...
            for (int i = 0; i < rows; i++) {
                ...
                if (!set.isEmpty()) {
                    ...
                    if (discount.getIsFixed().intValue() == com.school.constant.ConsFeesPayment.FIXED_FEES) {
                ...
                if (list.isEmpty()) {
                    ...
                    AppMsg.warning(this, "The Fees Of " + st.getStudentName() + " of " + mon.getMonthName() + "  is already generated.");
                    //                    if (option == JOptionPane.YES_OPTION) {
    ...
    private void buttonPrintChallan2MonthActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonPrintChallan2MonthActionPerformed
        try {
            ...
            if (checkBoxDuplicate.isSelected()) {
                ...
                int option = AppMsg.confirm2(this, msg);
            ...
            for (int i = 0; i < rows; i++) {
                ...
                try {
                    ...
                    if (feessList.size() < 1) {
                        AppMsg.info(this, month2nd.getMonthName() + " CHALLAN of " + fess.getStudentClassReg().getStudent().getStudentName() + " is NOT GENERATED \nNOT PRINTED");
                        continue;
                    ...
                    AppMsg.error(this, "Error Occured During fetching of " + fess.getStudentClassReg().getStudent().getStudentName() + " \n HENCE NOT PRINTED");
                    Logger.getLogger(AppLog.ERROR_LOG).log(Level.SEVERE, null, ex);
                    continue;
                }
    ...
    private void buttonSaveStudentFeesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSaveStudentFeesActionPerformed
        try {
            ...
            if (paidDate == null) {
                AppMsg.warning(this, D_Msg.MSG_69);
                return;
            }
            int rows = tableUnpaidStudents.getRowCount();
            for (int i = 0; i < rows; i++) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (!checkBoxFixedZero.isSelected()) {
                ...
                if (discounts.length > 0) {
                    ...
                    isFixed = discount.getIsFixed().intValue() == com.school.constant.ConsFeesPayment.FIXED_FEES;
    ...
    private void setFeesStructure() {
        try {
            ...
            if (feesAmount == null) {
                AppMsg.warning(this, "Fees of this class is not set");
            }
    ...
    private void refreshUnpaidPaidStudent() {
        ...
        Campus camp = (Campus) comboBoxCampus.getSelectedItem();
        CustomYear years = (CustomYear) comboBoxBatch.getSelectedItem();
        Months mon = (Months) comboBoxMonth.getSelectedItem();
        Classes cl = (Classes) comboBoxClass.getSelectedItem();
    ...
    private void getSchoolConfig() {
        try {
            List<SchoolConfig> list = DatabaseManager.getData(com.school.model.SchoolConfig.class, Restrictions.like("keyName", ConsConfiguration.SCHOOL));
            if (list.size() > 0) {
