 ...
 * @author JAY
 */
public class AttendancePanel extends JkPanel {
    ...
    public AttendancePanel(UserPrivilege privilege) {
        super(privilege);
    }
    ...
    private void listClassValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listClassValueChanged
        ...
        if (changeOccured) {
            int option = AppMsg.confirm2(this, D_Msg.MSG_16);
    ...
    private void buttonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSaveActionPerformed
        ...
        for (int rNo = 0; rNo < rows; rNo++) {
            ...
            try {
                ...
                AppMsg.warning(this, D_Msg.MSG_17+ (rNo + 1) +D_Msg.MSG_18);
                continue;
            }
            if (ob instanceof String) {
                ...
                try {
                    ...
                    if (attenList.isEmpty()) {
                        ...
                        AppMsg.error(this, D_Msg.MSG_19+D_Msg.MSG_20+ reg);
                    } else if (attenList.size() == 1) {
                        Attendence attendence = (Attendence) attenList.get(0);
                        attendence.setPresentDays(present);
                        if (abs != null) {
                            attendence.setRemarks(abs.toString());
                        }
                    ...
                    AppMsg.warning(this,D_Msg.MSG_17 + (rNo + 1));
                ...
                AppMsg.error(this,D_Msg.MSG_21 + (rNo + 1) + "\n" + ob.getClass());
            }
        }
        changeOccured = false;
        AppMsg.info(this, D_Msg.MSG_22);
